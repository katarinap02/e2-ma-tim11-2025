...
import com.example.team11project.presentation.adapters.PotionAdapter;
import com.example.team11project.presentation.viewmodel.StoreViewModel;

import java.util.ArrayList;

public class PotionStoreFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        adapter = new PotionAdapter(new ArrayList<>(), potion -> {
            storeViewModel.buyPotion(userId, potion);
            Toast.makeText(getContext(), "Kupljen: " + potion.getName(), Toast.LENGTH_SHORT).show();
        });
